...
class Operation:
    ...
    def signed_value(self):
        """Valor con signo: positivo para ingresos, negativo para gastos"""
    ...
    def from_dict(cls, data):
        """Reconstruye un objeto Operation desde un diccionario (JSON cargado)"""
        return cls(
            ID=data["ID"],
    ...
    @staticmethod
    def calculate_signed_value(value, is_income):
        """Función auxiliar para calcular valor con signo desde datos raw"""
        return value if is_income else -value
